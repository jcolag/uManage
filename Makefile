...
CFLAGS+=`pkg-config --cflags glib-2.0 gtk+-3.0 appindicator3-0.1` -g
...
uManageUi: $(UISOURCES) uManage.h config.h idle.h winmgmt.h indicate.h umenu_glade opts_glade
